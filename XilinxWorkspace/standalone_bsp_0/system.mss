...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = axi_gpio_oled
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axi_oled_controller
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axi_oled_controller_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_uart16550_internal_cross_connect1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartns550
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = axi_uart16550_internal_cross_connect2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartns550
 PARAMETER DRIVER_VER = 3.5
 PARAMETER HW_INSTANCE = axi_uart16550_internal_loopback
END
